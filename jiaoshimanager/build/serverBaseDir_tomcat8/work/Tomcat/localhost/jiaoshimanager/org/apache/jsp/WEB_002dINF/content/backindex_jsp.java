 ...
 * Generated at: 2016-11-30 11:34:03 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t{\"menuid\":\"1\",\"icon\":\"icon-sys\",\"menuname\":\"用户管理\",\r\n");
      out.write("\t\t\t\t\t\t\t\"menus\":[\r\n");
      out.write("\t\t\t\t\t\t\t\t\t{\"menuname\":\"用户管理\",\"icon\":\"icon-users\",\"url\":\"\"},\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t{\"menuname\":\"权限设置\",\"icon\":\"icon-set\",\"url\":\"\"},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t{\"menuname\":\"系统日志\",\"icon\":\"icon-log\",\"url\":\"\"}\r\n");
      out.write("\t\t\t\t\t\t\t\t]\r\n");
      out.write("\t\t\t\t\t\t},{\"menuid\":\"28\",\"icon\":\"icon-sys\",\"menuname\":\"教室管理\",\r\n");
      out.write("\t\t\t\t\t\t\t\"menus\":[{\"menuname\":\"教室管理\",\"icon\":\"icon-nav\",\"url\":\"\"}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t]\r\n");
      out.write("\t\t\t\t\t\t},{\"menuid\":\"39\",\"icon\":\"icon-sys\",\"menuname\":\"申请管理\",\r\n");
      out.write("\t\t\t\t\t\t\t\"menus\":[{\"menuname\":\"待处理申请\",\"icon\":\"icon-nav\",\"url\":\"/shop/productcatagory.aspx\"},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t{\"menuname\":\"申请记录\",\"icon\":\"icon-nav\",\"url\":\"manageritems\"}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t]\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t]};\r\n");
      ...
      out.write("        <span style=\"float:right; padding-right:20px;\" class=\"head\">欢迎 管理员<a href=\"#\" id=\"editpass\">修改密码</a> <a href=\"#\" id=\"loginOut\">安全退出</a></span>\r\n");
      out.write("        <span style=\"padding-left:10px; font-size: 16px; \"><img src=\"images/blocks.gif\" width=\"20\" height=\"20\" align=\"absmiddle\" /> 教室管理系统</span>\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t<h1>欢迎使用教室使用后台管理系统</h1>\r\n");
      out.write("\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("    </div>\r\n");
