    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						{"menuid":"1","icon":"icon-sys","menuname":"系统管理",
							"menus":[
									{"menuname":"用户管理","icon":"icon-users","url":"manageruser1"},									
							...
							"menus":[{"menuname":"收支分类","icon":"icon-nav","url":"demo.html"},
									{"menuname":"报表统计","icon":"icon-nav","url":"jschart"},
							...
							"menus":[{"menuname":"商品分类","icon":"icon-nav","url":"/shop/productcatagory.aspx"},
									{"menuname":"商品列表","icon":"icon-nav","url":"manageritems"},
									{"menuname":"商品订单","icon":"icon-nav","url":"backorders"}
								]
						}
				]};
        //设置登录窗口
