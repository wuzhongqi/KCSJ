					...
					<div class="container">
						...
						<div class="service-grids">
							<div class="col-md-4 service-grid">
								...
								<h4>教室审批</h4>
								<p>集体活动</p>
								<a href="shenqing" class="button hvr-shutter-in-horizontal">申请</a>
							</div>
							<div class="col-md-4 service-grid">
								<img src="images/icon2.png">
								<h4>空教室查询</h4>
								<p>个人自习</p>
								<a href="look" class="button hvr-shutter-in-horizontal">查询</a>
							</div>
							<div class="col-md-4 service-grid">
								<img src="images/icon3.png">
								<h4>教室使用情况</h4>
								<p>查询每个教室的具体使用情况</p>
								<a href="lookuse" class="button hvr-shutter-in-horizontal">查询</a>
							</div>
								<div class="clearfix"></div>
							</div>
						</div>
