	...
	<div align="center">
		<div class="login-main">
			...
			<div class="login-bottom">
				...
				<p><label for="phone">用户名</label></p>
				<input name="student_id" type="text" value="" placeholder="请输入您的学号"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}"/><br>
				<p><label for="password">密码</label></p>
				<input name="password" type="password" value="">
				<p><a href="findpassword">忘记密码</a>&nbsp;</p>
