...
<head id="Head1">
    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						},{"menuid":"28","icon":"icon-sys","menuname":"教室管理",
							"menus":[{"menuname":"教室管理","icon":"icon-nav","url":""}
									
								]
						},{"menuid":"39","icon":"icon-sys","menuname":"申请管理",
							"menus":[{"menuname":"待处理申请","icon":"icon-nav","url":"/shop/productcatagory.aspx"},
									{"menuname":"申请记录","icon":"icon-nav","url":"manageritems"}
...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; "><img src="images/blocks.gif" width="20" height="20" align="absmiddle" /> 教室管理系统</span>
    </div>
